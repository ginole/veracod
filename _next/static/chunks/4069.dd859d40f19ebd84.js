"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4069],{4069:(A,e,t)=>{t.r(e),t.d(e,{MorphingGlyphCloud:()=>p});var a=t(5155),r=t(2115);let i=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<div class="frame">
  <header>
    ...
    <div class="nav">WRITE \xb7 RIPPLE \xb7 ROLL</div>
  </header>
...
(function(){
  ...
  var Ripple = (function(){
    ...
    var s  = new Surface(cv);
    var N  = 24;
    var CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789=?#\xa7\xb6△◊\xd7\xf7%@&*/<>+-$\xa5\xa3~^|:;.,()[]{}";
    var plate = [];
    (function(){
      var r = rng(20260809);
  ...
  var Ball = (function(){
    ...
    var s  = new Surface(cv);
    var CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789=?#\xa7\xb6△◊\xd7\xf7%@&*/<>+-$\xa5\xa3ΑΒΓΔΕΖΗΘΛΞΠΣΦΨΩαβγδεζηθλμξπστυφχψω\xab\xbb‹›";
    var N = 1900;
    var pts = [];
    (function(){
      var r = rng(77712345);
...
<div class="frame">
  <header>
    ...
    <div class="nav">GLOBE \xb7 CODEX \xb7 CLAUDE \xb7 BOOK \xb7 CARD \xb7 CLOTH</div>
  </header>
...
`,s={mode:"dark",scale:1,opacity:1,hue:0,saturation:1,brightness:1},o={globe:{source:n,index:1,title:"Globe",layout:"figures"},outlineTypeflow:{source:n,index:2,title:"Outline Typeflow",layout:"figures",renderDensity:{minimum:2,maximum:2.5}},morphingGlyphCloud:{source:n,index:3,title:"Morphing Glyph Cloud",layout:"figures",renderDensity:{minimum:2,maximum:2.5}},cloth:{source:n,index:6,title:"Cloth",layout:"figures"},ripple:{source:i,index:2,title:"Ripple",layout:"cards",presentation:"dark-frameless"},ball:{source:i,index:3,title:"Ball",layout:"cards",presentation:"dark-frameless"}};function l(A,e,t){return Math.min(t,Math.max(e,A))}o.globe,o.outlineTypeflow,o.morphingGlyphCloud,o.cloth,o.ripple,o.ball;let d="var INK  = '20,19,16';";function c(A,e,t){if(!A.includes(e))throw Error(`Text path source adapter could not find: ${e}`);return A.replace(e,t)}function h({definition:A,mode:e=s.mode,scale:t=s.scale,opacity:i=s.opacity,hue:n=s.hue,saturation:o=s.saturation,brightness:h=s.brightness,className:p,style:v}){let f="light"===e?"light":"dark",g=(0,r.useMemo)(()=>(function(A,e){let t="dark-frameless"===A.presentation?[[d,"light"===e?d:"var INK  = '238,240,244';"],[`      var cell = s.w * 0.02860;
      ...
      var R  = size*RR;
      var fs = size*FS;`],["      var g = s.w*0.80;","      var g = size*0.80;"]].reduce((A,[e,t])=>c(A,e,t),A.source):"light"===e?c(A.source,"var INK  = '226,228,233';","var INK  = '38,40,48';"):A.source;return(A.renderDensity?t.replace("var dpr = Math.min(1.5, window.devicePixelRatio || 1);",`var dpr = Math.min(${A.renderDensity.maximum}, Math.max(${A.renderDensity.minimum}, window.devicePixelRatio || 1));`):t).replace(/<title>[\s\S]*?<\/title>/i,`<title>${A.title} — ThreeUI</title>`).replace("</head>",`${function(A,e){let t=A.index,a="light"===e?"#f3f5f8":"#08090a",r="light"===e?`
      :root {
        color-scheme: light;
        --bg: #f3f5f8;
    ...
    `:":root { color-scheme: dark; }",i="dark-frameless"===A.presentation?`
      .stage, .row {
    ...
    body { margin: 0 !important; background: ${a} !important; }
    .frame { padding: 0 !important; background: ${a} !important; }
    header { display: none !important; }
    ${n}
  </style>`}(A,e)}
</head>`)})(A,f),[A,f]),x=l(t,.65,1.5),u=l(i,.1,1),w=l(n,-180,180),y=l(o,0,2),m=l(h,.4,1.8),b=0===w&&1===y&&1===m?void 0:`hue-rotate(${w}deg) saturate(${y}) brightness(${m})`;return(0,a.jsx)("div",{className:["text-path-study",`text-path-study--${f}`,p].filter(Boolean).join(" "),"data-mode":f,style:{opacity:u,filter:b,...v},children:(0,a.jsx)("iframe",{className:"text-path-study-frame","data-mode":f,title:`${A.title} interactive canvas study`,sandbox:"allow-scripts",srcDoc:g,style:{transform:1===x?void 0:`scale(${x})`}})})}function p(A={}){return(0,a.jsx)(h,{definition:o.morphingGlyphCloud,...A})}}}]);