"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5335],{5335:(e,t,a)=>{a.r(t),a.d(t,{GenerativeTree:()=>c});var r=a(5155),n=a(2115);let o=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
`,i={speed:1,size:1,particleAmount:1,opacity:1,hue:0,saturation:1,brightness:1};function s(e,t,a){return Math.min(a,Math.max(t,e))}function c({speed:e=i.speed,size:t=i.size,particleAmount:a=i.particleAmount,opacity:c=i.opacity,hue:l=i.hue,saturation:d=i.saturation,brightness:h=i.brightness,className:p="",style:u}){let f=(0,n.useRef)(null),[g,m]=(0,n.useState)(!0),[b,w]=(0,n.useState)(()=>typeof document>"u"||!document.hidden),x=s(e,0,3),T=!g||!b||0===x,v=(0,n.useMemo)(()=>(function(e,t){let a=Math.max(0,Math.round(50*s(t,0,2))),r=1/s(e,.65,1.5);return o.replace(/<script[^>]+cloudflareinsights\.com[^>]*><\/script>/gi,"").replace("</head>",`<style data-generative-tree-focus>
...
(function () {
...
</script></head>`).replace("const PARTICLE_COUNT = 50;",`const PARTICLE_COUNT = ${a};`).replace("const _pad = parseFloat(new URLSearchParams(location.search).get('p')) || 1;",`const _pad = ${r.toFixed(4)};`).replace(`function frame(time) {
  ...
  requestAnimationFrame(startTreeWhenSized);`)})(t,a),[a,t]),E=(0,n.useCallback)(()=>{f.current?.contentWindow?.postMessage({type:"generative-tree-controls",controls:{speed:x,paused:T}},"*")},[T,x]);return(0,n.useEffect)(()=>{let e=f.current;if(!e||typeof IntersectionObserver>"u")return;let t=new IntersectionObserver(([e])=>m(e?.isIntersecting??!0));return t.observe(e),()=>t.disconnect()},[]),(0,n.useEffect)(()=>{if(typeof document>"u")return;let e=()=>w(!document.hidden);return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},[]),(0,n.useEffect)(()=>{E()},[E,v]),(0,r.jsx)("div",{className:`threeui-background generative-tree${p?` ${p}`:""}`,style:{background:"#0a0a0a",pointerEvents:"auto",...u},children:(0,r.jsx)("iframe",{ref:f,title:"Generative Tree background",srcDoc:v,sandbox:"allow-scripts",onLoad:E,"aria-hidden":"true",tabIndex:-1,style:{position:"absolute",inset:0,display:"block",width:"100%",height:"100%",border:0,background:"#0a0a0a",opacity:s(c,.05,1),filter:`hue-rotate(${s(l,-180,180)}deg) saturate(${s(d,0,2)}) brightness(${s(h,.35,1.8)})`}})})}}}]);