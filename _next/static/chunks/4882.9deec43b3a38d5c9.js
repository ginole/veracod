"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4882],{4882:(e,t,i)=>{i.r(t),i.d(t,{ElementsBackground:()=>u});var a=i(5155),o=i(2115);let n=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<main>
  <section class="panel" data-fx="water">
    ...
    <div class="info">
      ...
      <h2>OpenAI</h2>
      <p class="tech">ping-pong wave equation \xb7 gradient refraction of the mark</p>
    </div>
  ...
  <section class="panel" data-fx="lightning">
    ...
    <div class="info">
      ...
      <h2>Anthropic</h2>
      <p class="tech">contour distance field \xb7 fBm zigzag arcs crawling the outline</p>
    </div>
  ...
  <section class="panel" data-fx="fire">
    ...
    <div class="info">
      ...
      <h2>Claude</h2>
      <p class="tech">noise ribbons licking upward from the edge \xb7 rising embers</p>
    </div>
    <div class="fail">WEBGL2 UNAVAILABLE</div>
  </section>
</main>
...
`,s=["water","lightning","fire"],l={variant:"water",speed:1,size:1,particleAmount:1,opacity:1,hue:0,saturation:1,brightness:1},r={water:"Water",lightning:"Lightning",fire:"Fire"},c={water:1.56,lightning:1.66,fire:1.82},f={water:"1.06",lightning:"1.10",fire:"1.16"},h={water:160,lightning:360,fire:560},p={water:160,lightning:240,fire:420},d=[[`const SDF_SIZE = 512;
...
const SDF_SPREAD = 192;`],["const DPR = Math.min(window.devicePixelRatio || 1, 1.75);","const DPR = Math.min(Math.max(window.devicePixelRatio || 1, 1.5), 2.25);"],["sim: false, zoom: 1.16, shift: [0, -0.04],","sim: false, zoom: 1.16, shift: [0, -0.11],"],[`  float inside = smoothstep(0.005, -0.005, d);
  ...
  col += exp(-max(d0, 0.0) / 0.09)  * vec3(0.55, 0.14, 0.03) * 0.28 * (0.55 + 0.45 * n2);`],[`count: 240, travel: 0.055, lifeMin: 0.3, lifeMax: 0.9, alongNormal: 1.0,
      ...
      wiggle: 0.046, sizeMin: 0.9, sizeMax: 3.6, sparse: 0.42,`]];function m(e,t,i){return Math.min(i,Math.max(t,e))}function u({variant:e=l.variant,speed:t=l.speed,size:i=l.size,particleAmount:u=l.particleAmount,opacity:v=l.opacity,hue:g=l.hue,saturation:x=l.saturation,brightness:b=l.brightness,className:y="",style:w}){let S=(0,o.useRef)(null),[E,T]=(0,o.useState)(!0),[A,R]=(0,o.useState)(()=>typeof document>"u"||!document.hidden),M=s.includes(e)?e:l.variant,_=m(t,0,3),D=!E||!A,U=(0,o.useMemo)(()=>(function(e,t,i){let a=c[e]/m(t,.65,1.5),o=Math.max(0,Math.round(h[e]*m(i,0,2))),s=`<style data-elements-focus>
...
.panel[data-fx="${e}"] canvas { width: 100%; height: 100%; }
</style>`;return d.reduce((e,[t,i])=>e.replace(t,i),n).replace(/<link[^>]+fonts\.googleapis\.com[^>]*>/gi,"").replace(/<link[^>]+fonts\.gstatic\.com[^>]*>/gi,"").replace("</head>",`${s}<script data-elements-controls>
(function () {
...
</script></head>`).replace(RegExp(`count: ${p[e]}`),`count: ${o}`).replace(`zoom: ${f[e]}`,`zoom: ${a.toFixed(4)}`).replace("for (const p of panels) p.draw(t);","if (!window.__ELEMENTS_PAUSED) for (const p of panels) p.draw(t);")})(M,i,u),[u,M,i]),P=(0,o.useCallback)(()=>{S.current?.contentWindow?.postMessage({type:"elements-controls",controls:{speed:_,paused:D}},"*")},[D,_]);return(0,o.useEffect)(()=>{let e=S.current;if(!e||typeof IntersectionObserver>"u")return;let t=new IntersectionObserver(([e])=>T(e?.isIntersecting??!0));return t.observe(e),()=>t.disconnect()},[]),(0,o.useEffect)(()=>{if(typeof document>"u")return;let e=()=>R(!document.hidden);return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},[]),(0,o.useEffect)(()=>{P()},[P,U]),(0,a.jsx)("div",{className:`threeui-background elements${y?` ${y}`:""}`,"data-element":M,style:{background:"#060708",pointerEvents:"auto",...w},children:(0,a.jsx)("iframe",{ref:S,title:`${r[M]} element background`,srcDoc:U,sandbox:"allow-scripts",onLoad:P,"aria-hidden":"true",tabIndex:-1,style:{position:"absolute",inset:0,display:"block",width:"100%",height:"100%",border:0,background:"#060708",opacity:m(v,.05,1),filter:`hue-rotate(${m(g,-180,180)}deg) saturate(${m(x,0,2)}) brightness(${m(b,.35,1.8)})`}})})}}}]);