"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2384],{2384:(t,a,e)=>{e.r(a),e.d(a,{BrandOrbs:()=>g});var s=e(5155),i=e(2115);let n=`<!doctype html>
...
`,o=["claude","openai","codex","cursor","gemini","figma","framer","react","swift","designcode","aura","dreamcut","ui","ux","css","ios","neuform","github","x","instagram","threads","linkedin","email"],c=["small","medium"],r={variant:"claude",size:"medium",mode:"dark",speed:1,paused:!1},l={small:20,medium:56},d={claude:"Claude Code",openai:"OpenAI",codex:"Codex",cursor:"Cursor",gemini:"Gemini",figma:"Figma",framer:"Framer",react:"React",swift:"Swift",designcode:"DesignCode",aura:"Aura",dreamcut:"DreamCut",ui:"UI",ux:"UX",css:"CSS",ios:"iOS",neuform:"Neuform",github:"GitHub",x:"X",instagram:"Instagram",threads:"Threads",linkedin:"LinkedIn",email:"Email"};function p(){if(typeof document>"u"||typeof window>"u")return"dark";let t=document.documentElement.dataset.theme??document.documentElement.dataset.scheme;return"light"===t||"dark"===t?t:document.documentElement.classList.contains("light")?"light":document.documentElement.classList.contains("dark")||window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}let h=([...n.matchAll(/<script(?:\s[^>]*)?>([\s\S]*?)<\/script>/gi)].at(-1)?.[1]??"").replace(/<\/script/gi,"<\\/script");function g({variant:t=r.variant,size:a=r.size,mode:e=r.mode,speed:n=r.speed,paused:g=r.paused,"aria-label":v,className:m,style:x}){let u=(0,i.useRef)(null),[y,f]=(0,i.useState)(!0),[b,w]=(0,i.useState)(()=>typeof document>"u"||!document.hidden),k=function(t){let[a,e]=(0,i.useState)(p);return(0,i.useEffect)(()=>{if(!t||typeof document>"u"||typeof window>"u")return;let a=window.matchMedia("(prefers-color-scheme: dark)"),s=()=>e(p()),i=new MutationObserver(s);return i.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-scheme","data-theme"]}),a.addEventListener("change",s),s(),()=>{i.disconnect(),a.removeEventListener("change",s)}},[t]),a}("auto"===e),M="auto"===e?k:e,z=o.includes(t)?t:r.variant,C=c.includes(a)?a:r.size,S=Math.min(3,Math.max(.1,n)),A=g||!y||!b,E=(0,i.useMemo)(()=>(function(t,a,e){let s=l[a],i=JSON.stringify(t).replace(/</g,"\\u003c"),n=`<script data-brand-orbs-controls>
(function () {
...
</script>`,o=h.replace('if (document.visibilityState !== "hidden")','if (document.visibilityState !== "hidden" && !window.__BRAND_ORB_PAUSED)');return`<!doctype html>
<html lang="en" data-theme="${e}">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>${d[t]} Brand Orb</title>
<style>
html, body { width: 100%; height: 100%; margin: 0; overflow: hidden; background: ${"light"===e?"#dad7cc":"#050608"}; }
body { display: grid; place-items: center; }
canvas { display: block; width: ${s}px; height: ${s}px; filter: ${"light"===e?"invert(1) hue-rotate(180deg) contrast(1.04) saturate(.92)":"none"}; }
</style>
${n}
</head>
<body>
<canvas data-mode=${i} data-size="${s}" aria-hidden="true"></canvas>
<script>${o}</script>
</body>
</html>`})(z,C,M),[M,C,z]),L="light"===M?"#dad7cc":"#050608",T=(0,i.useCallback)(()=>{u.current?.contentWindow?.postMessage({type:"brand-orbs-controls",controls:{speed:S,paused:A}},"*")},[A,S]);return(0,i.useEffect)(()=>{let t=u.current;if(!t||typeof IntersectionObserver>"u")return;let a=new IntersectionObserver(([t])=>f(t?.isIntersecting??!0));return a.observe(t),()=>a.disconnect()},[]),(0,i.useEffect)(()=>{if(typeof document>"u")return;let t=()=>w(!document.hidden);return document.addEventListener("visibilitychange",t),()=>document.removeEventListener("visibilitychange",t)},[]),(0,i.useEffect)(()=>{T()},[T,E]),(0,s.jsx)("iframe",{ref:u,className:m,title:v??`${d[z]} animated brand orb`,srcDoc:E,sandbox:"allow-scripts",loading:"eager",onLoad:T,style:{display:"block",width:"100%",height:"100%",border:0,background:L,...x}})}}}]);