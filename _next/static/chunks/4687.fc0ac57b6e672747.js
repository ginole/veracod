"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4687],{4687:(e,t,i)=>{i.r(t),i.d(t,{EmberStorm:()=>u,EngravedCertificate:()=>b,FluidFieldBackground:()=>m,HalftoneFlow:()=>h,NEUFORM_CRAFT_DEFAULTS:()=>n,NebulaBackground:()=>g,NeonTypography:()=>x,WovenCloth:()=>f});var a=i(5155),r=i(2115);let n={hue:0,saturation:1,brightness:1},o={neon:{title:"Animated neon typography",source:`<!doctype html>
<html lang="en-GB">
<head>
  <meta charset="utf-8">
...
`,background:e=>"light"===e?"#f4f4f2":"#090909",targets:[{selector:"#board",role:"ui",width:"1040px"}],presentation:"animated-typography"},luminaWeaversCloth:{title:"Woven Cloth kinetic textile",source:`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover">
    <title>Lumina Weavers \xb7 Kinetic Textiles, Kyoto</title>
    ...
    <script>
        ...
        (() => {
            ...
            function makeClothTexture() {
                ...
                x.fillStyle = '#7c1622';
                x.fillText('\xb7 KYOTO \xb7', W/2, 246);
                ...
                x.fillText('K I N E T I C   T E X T I L E S   \xb7   2 0 2 4', W/2, 626);
...
</html>`,background:"#16090b",targets:[{selector:"body > div.fixed.inset-0.overflow-hidden.z-0",role:"background"}],presentation:"woven-cloth-label"},julianVanceNebula:{title:"Julian Vance nebula background",source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
</html>`,background:"#09090b",targets:[{selector:"#bg-canvas",role:"background"}]},fluid:{title:"Aura UI fluid background",source:`<!doctype html>
<html lang="en"><head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <div id="mock-app" class="w-full mt-8 rounded-t-2xl overflow-hidden flex flex-col shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] min-h-[600px] opacity-0 translate-y-12 bg-gradient-to-b from-[#161616cc] to-[#0c0c0ce6] backdrop-blur-[12px] border-t border-t-white/10 border-x border-x-white/5 border-b border-b-black/50" style="box-shadow: inset 0 1px 0 0 rgba(255,255,255,0.05);">
            ...
            <header class="h-14 border-b border-[#262626] flex items-center justify-between px-4 bg-[#111111]">
                ...
                <div class="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 text-sm text-[#A3A3A3] font-light">
                    ...
                    <span class="font-geist">\xb7</span>
...
</body></html>`,background:"#030306",targets:[{selector:"#bg-canvas",role:"background"}]},nexusUnifiedFlow:{title:"Nexus unified halftone flow",source:`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`,background:"#000000",targets:[{selector:"#glcanvas",role:"background"}]},emberStorm:{title:"Aeonix ember storm",source:`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body class="bg-ink font-sans text-ash overflow-hidden relative h-screen w-screen selection:bg-ember/30 selection:text-white">
    ...
    <div class="coretemp hidden lg:block fixed z-[4] right-[clamp(20px,9vw,140px)] top-[clamp(96px,21vh,200px)] text-right pointer-events-none opacity-0">
        ...
        <div class="v font-brand font-semibold text-[clamp(26px,3vw,40px)] leading-[0.9] text-[#fff2e2] tracking-[0.01em]">
            <span data-count="82" data-dec="0">0</span><small class="font-display text-[0.42em] text-ember-hot tracking-[0.06em] ml-1 font-medium">\xb0C</small>
        </div>
    </div>
...
</html>`,background:"#080503",targets:[{selector:"#gl",role:"background"}]},engravedCertificate:{title:"Kinetic Lathe certificate",source:`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">
  ...
  <main>
    <article id="cert" aria-label="Kinetic Lathe certificate">
      ...
      <div class="face">
        ...
        <h1>Matrix 92 \xb7 Cam <em id="barName">C</em></h1>
        <div class="caption">Primary cam \xb7 <span id="capBar">C</span></div>
      </div>
    </article>
  </main>
<script>
...
`,background:"#ded6c2",targets:[{selector:"#cert",role:"ui",width:"720px"}]}};function s(e,t,i){return Math.min(i,Math.max(t,e))}function l(e,t,i){if(!e.includes(t))throw Error(`Neuform source adapter could not find: ${t}`);return e.replace(t,i)}function c(e,t){return"function"==typeof e.background?e.background(t):e.background}function d({definition:e,mode:t="dark",hue:i=n.hue,saturation:o=n.saturation,brightness:d=n.brightness,className:p,style:x}){let f="light"===t?"light":"dark",g=c(e,f),m=(0,r.useMemo)(()=>(function(e,t){let i=JSON.stringify(e.targets).replace(/</g,"\\u003c"),a=c(e,t),r="light"===t?"grayscale(1) invert(1) contrast(1.08)":"grayscale(1) contrast(1.08)",n="animated-typography"===e.presentation?`
...
${n}
</style>`,s=`<script data-threeui-focus>
(function () {
  var isolated = false;
  function isolate() {
    if (isolated) return;
...
</script>`;return("animated-typography"===e.presentation?[["return { t0: after + 5.6 + frnd() * 7.2, dur: total, segs: segs };","return { t0: after + 1.25 + frnd() * 1.75, dur: total, segs: segs };"],["if (!ev) ev = nextEvent(4.2);","if (!ev) ev = nextEvent(0.55);"],["cap = Math.min((W - W * 0.12) / blockW, (H - H * 0.18) / blockH);","cap = Math.min((W - W * 0.20) / blockW, (H - H * 0.28) / blockH);"],["var y0 = (H - blockH * cap) * 0.48;","var y0 = (H - blockH * cap) / 2;"]].reduce((e,[t,i])=>l(e,t,i),e.source):"woven-cloth-label"===e.presentation?[["x.fillText('L W', W/2, 190);","x.fillText('W C', W/2, 190);"],["x.fillText('\xb7 KYOTO \xb7', W/2, 246);","x.fillText('\xb7 WOVEN CLOTH \xb7', W/2, 246);"],["x.fillText('LUMINA', W/2, 400);","x.fillText('WOVEN', W/2, 400);"],["x.fillText('WEAVERS', W/2, 520);","x.fillText('CLOTH', W/2, 520);"],["x.fillText('K I N E T I C   T E X T I L E S   \xb7   2 0 2 4', W/2, 626);","x.fillText('T E X T I L E   S I M U L A T I O N', W/2, 626);"]].reduce((e,[t,i])=>l(e,t,i),e.source):e.source).replace(/<\/head>/i,`${o}</head>`).replace(/<\/body>/i,`${s}</body>`)})(e,f),[e,f]),h=s(i,-180,180),u=s(o,0,2),b=s(d,.35,1.65),v=0===h&&1===u&&1===b?void 0:`hue-rotate(${h}deg) saturate(${u}) brightness(${b})`;return(0,a.jsx)("iframe",{className:p,"data-mode":f,title:e.title,srcDoc:m,sandbox:"allow-scripts",loading:"eager",style:{display:"block",width:"100%",height:"100%",border:0,background:g,filter:v,...x}})}function p(e){return function(t){return(0,a.jsx)(d,{...t,definition:e})}}let x=p(o.neon),f=p(o.luminaWeaversCloth),g=p(o.julianVanceNebula),m=p(o.fluid),h=p(o.nexusUnifiedFlow),u=p(o.emberStorm),b=p(o.engravedCertificate)}}]);